document.addEventListener("DOMContentLoaded", function () {
  ...
  function openSlideDetailModal(item, modalId, imageId, descriptionId) {
    ...
    if (modalImage) {
      modalImage.src =
        item.image ||
        "https://via.placeholder.com/1280x700/CCCCCC/666666?text=بدون+عکس"; // Fallback image
      ...
      bullets.forEach((bullet, index) => {
        ...
        if (progressCircle) {
          ...
          if (index === realIndex) {
            ...
            progressCircle.style.animation = `fill-circle ${
              pmsAutoplayDelay / 1000
            }s linear forwards`;
          } else {
  ...
  if (statItems.length > 0) {
    const animateStat = (item) => {
      ...
      function animationStep(timestamp) {
        ...
        numberSpan.innerText = toPersianDigits(
          isFloat ? currentCount.toFixed(1) : Math.floor(currentCount)
        );
        const offset =
          circumference - progress * circumference * (target / 100);
  ...
  const shirazNewsContainer = document.querySelector(
  ...
  if (shirazNewsContainer) {
      ...
      "پایگاه خبری": [
        {
          ...
          description:
            "با هدف تقویت هویت شهری و مستندسازی تاریخ و فرهنگ شیراز، مرکز شیرازشناسی در بوستان بعثت افتتاح شد. این مرکز که در بنایی تاریخی و مرمت‌شده به نام کوشک بعثت قرار دارد، شامل بخش‌های پژوهشی، نمایشگاهی و آموزشی است. در مراسم افتتاحیه، از دانشنامه ۱۷ جلدی شیراز نیز رونمایی شد که حاصل سال‌ها تلاش پژوهشگران بومی است. مرکز شیرازشناسی به‌عنوان مرجع فرهنگی برای شهروندان، دانشجویان و گردشگران طراحی شده و قرار است میزبان نشست‌های تخصصی، کارگاه‌های آموزشی و نمایشگاه‌های موضوعی باشد. این اقدام شهرداری شیراز در راستای ارتقای آگاهی عمومی نسبت به پیشینه تاریخی شهر، گامی مؤثر در توسعه پایدار فرهنگی محسوب می‌شود.",
          image: "../images/roydad/img1.webp",
        },
        {
          title: "افتتاح مرکز شیرازشناسی در بوستان بعثت",
          description:
            "شهرداری شیراز با هدف بهبود وضعیت ترافیک شهری، طرح‌های نوینی را به اجرا گذاشته است. این طرح‌ها شامل توسعه حمل و نقل عمومی، هوشمندسازی چراغ‌های راهنمایی و رانندگی، و فرهنگ‌سازی در زمینه استفاده کمتر از خودروی شخصی است. امید است با این اقدامات، شاهد روان‌تر شدن ترافیک در ساعات اوج باشیم.",
          image: "../images/roydad/img2.webp",
        },
        {
          title: "افتتاح فاز جدید پل کابلی ولیعصر (عج) شیراز",
          description:
            "فاز جدید پل کابلی ولیعصر (عج) در شیراز به بهره‌برداری رسید. این پروژه که از جمله طرح‌های بزرگ عمرانی شهرداری شیراز محسوب می‌شود، نقش بسزایی در روان‌سازی ترافیک و تسهیل عبور و مرور در یکی از پرترددترین نقاط شهر ایفا خواهد کرد.",
          image: "../images/roydad/img3.webp",
        },
        {
          title: "افزایش ظرفیت گردشگری با اقامتگاه‌های بوم‌گردی",
          description:
            "با هدف توسعه صنعت گردشگری و جذب بیشتر توریست، چندین اقامتگاه بوم‌گردی جدید در مناطق مختلف شیراز و اطراف آن به بهره‌برداری رسید. این اقامتگاه‌ها با حفظ معماری سنتی، تجربه‌ای متفاوت و اصیل از فرهنگ و طبیعت فارس را برای بازدیدکنندگان فراهم می‌کنند.",
          image: "../images/roydad/img4.webp",
        },
        {
          title: "تقاطع غیرهمسطح شهیدان آماده بهره‌برداری",
          description:
            "فاز جدید پل کابلی ولیعصر (عج) در شیراز به بهره‌برداری رسید. این پروژه که از جمله طرح‌های بزرگ عمرانی شهرداری شیراز محسوب می‌شود، نقش بسزایی در روان‌سازی ترافیک و تسهیل عبور و مرور در یکی از پرترددترین نقاط شهر ایفا خواهد کرد.",
          image: "../images/roydad/img5.webp",
        },
      ],
      ...
      "گزارش تصویری": [
        {
          ...
          description:
            "اغ تاریخی عفیف‌آباد میزبان نمایشگاهی از صنایع‌دستی هنرمندان شیرازی بود. از خاتم‌کاری و قلم‌زنی گرفته تا سفال و گلیم، آثار هنری اصیل ایرانی در فضایی سنتی به نمایش درآمدند. این نمایشگاه فرصتی برای آشنایی با هنرهای بومی و حمایت از تولیدکنندگان محلی فراهم کرد.",
          image: "../images/Video report/img1.webp",
        },
        {
          title: " جشنواره خیابانی «رنگ زندگی» در بلوار چمران",
          description:
            "در یک رویداد پرشور هنری، خیابان‌های بلوار چمران شیراز میزبان جشنواره «رنگ زندگی» شدند. هنرمندان خیابانی با نقاشی، موسیقی زنده و نمایش‌های تعاملی، فضای شهری را به گالری زنده‌ای تبدیل کردند. این جشنواره با هدف ترویج هنر شهری و مشارکت مردمی برگزار شد و با استقبال گسترده شهروندان همراه بود.",
          image: "../images/Video report/img2.webp",
        },
        {
          title: "تئاتر خیابانی صدای شهر در شیراز",
          description:
            "گروهی از هنرمندان جوان با اجرای تئاتر خیابانی «صدای شهر» در میدان شهرداری، روایت‌هایی از زندگی روزمره شهروندان را به تصویر کشیدند. این اجرا با محوریت همدلی، عدالت اجتماعی و امید، توجه رهگذران را جلب کرد و تحسین بسیاری را برانگیخت.",
          image:
            "../images/Video report/img3.webp",
        },
        {
          title: "جشن شب یلدای محله سنگ سیاه شیراز",
          description:
            "در شب یلدا، اهالی محله سنگ سیاه با برگزاری جشن محلی، آیین‌های سنتی ایرانی را زنده کردند. از شاهنامه‌خوانی و موسیقی سنتی گرفته تا سفره‌های رنگارنگ و بازی‌های محلی، این جشن نمادی از همبستگی و هویت فرهنگی بود",
          image: "../images/Video report/img4.webp",
        },
        {
          title: "کارگاه نقاشی کودکان در شیراز",
          description:
            "فرهنگسرای طوبی میزبان کارگاه نقاشی ویژه کودکان بود. در این برنامه، کودکان با راهنمایی مربیان هنری، احساسات خود را روی بوم آوردند. هدف از این کارگاه، پرورش خلاقیت، افزایش اعتماد به نفس و آشنایی با رنگ‌ها و فرم‌ها بود.",
          image: "../images/Video report/img5.webp",
        },
      ],
    ...
    function setShirazNewsBulletAnimation(swiperInstance) {
      ...
      bullets.forEach((bullet, index) => {
        const progressCircle = bullet.querySelector(
    ...
    function populateShirazNewsSwiper(dataArray) {
      const swiperWrapper = document.querySelector(
        ".shiraz-news-swiper .swiper-wrapper"
      );
      ...
      shirazNewsSwiperInstance = new Swiper(".shiraz-news-swiper", {
        ...
        pagination: {
          ...
          clickable: true,
          renderBullet: function (index, className) {
            return `<span class="${className} shiraz-news-swiper-pagination-bullet"><svg class="shiraz-news-progress-circle-svg" viewBox="0 0 36 36"><circle class="shiraz-news-background-circle" cx="18" cy="18" r="16"></circle><circle class="shiraz-news-progress-circle" cx="18" cy="18" r="16"></circle></svg><span class="shiraz-news-bullet-number">${
              index + 1
            }</span></span>`;
          },
        },
          ...
          click: function (swiper, event) {
            ...
            if (clickedSlide) {
              const currentCategory =
                document.querySelector(".shiraz-news-category-btn.active")
                  ?.dataset.category || shirazNewsDefaultCategory;
              const clickedData =
                shirazNewsSliderData[currentCategory]?.[swiper.realIndex];
              if (clickedData) {
                openSlideDetailModal(
                  clickedData,
                  "shirazNewsSlideDetailModal",
                  "shirazNewsModalImage",
                  "shirazNewsModalDescription"
                );
              }
            }
          },
    ...
    const defaultButton = document.querySelector(
      `.shiraz-news-category-btn[data-category="${shirazNewsDefaultCategory}"]`
    );
  ...
  if (cardsContainer) {
    const cardsData = [
      {
        imageSrc: "../images/Cards Images/City information.webp",
        title: "اطلاعات شهری",
        description:
          "شیراز با جمعیتی نزدیک به ۱٫۷ میلیون نفر در سال ۲۰۲۵، قلب اداری و تاریخی استان فارس است؛ شهری که به باغ‌های باستانی و لقب شهر شعر و شهره دارد.",
        likeCount: "۱۵۰۰",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #E9EDF1 0%, #FFFFFF 100%)",
      ...
      {
        imageSrc: "../images/Cards Images/Tourism.webp",
        title: "گردشگری و توریسم",
        description:
          "از باغ ارم، یونسکو تا مسجد نصیرالملک, دروازه قرآن و بازار وکیل. دیدنی‌های شیراز هر سال هزاران مسافر ایرانی و خارجی را مجذوب خود می‌کند.",
        likeCount: "۲۵",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #FFE6C1 0%, #FFFFFF 84.13%)",
      ...
      {
        imageSrc: "../images/Cards Images/Culture and art.webp",
        title: "فرهنگ و هنر",
        description:
          "شیراز زادگاه حافظ و سعدی است؛ هر شب دوست‌داران ادب برای فال و غزل به آرامگاه شاعر محبوب‌شان در حافظیه سر می‌زنند و حال‌وهوای کاملاً فرهنگی را تجربه می‌کنند.",
        likeCount: "۲۵",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #F3D6F5 0%, #FFFFFF 84.13%)",
      ...
      {
        imageSrc: "../images/Cards Images/Religious attractions.webp",
        title: "جاذبه‌های مذهبی",
        description:
          "حرم باشکوه شاهچراغ با گنبد فیروزه‌ای و آینه‌کاری چشم‌نوازش، مهم‌ترین قطب زیارتی شیراز است و برای اولین بار به سده دوازدهم میلاد برمی‌گردد.",
        likeCount: "۲۵",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #FFF1C8 0%, #FFFFFF 84.13%)",
      ...
      {
        imageSrc: "../images/Cards Images/Tourist map.webp",
        title: "نقشه گردشگری شیراز",
        description:
          "نقشه تعاملی گردشگری شهر، جاذبه‌ها، رستوران‌ها و مسیرهای حمل‌ونقل را یکجا نمایش می‌دهد تا برنامه‌ریزی سفر در تلفن همراهتان ساده و سریع باشد.",
        likeCount: "۲۵",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #D0F0FF 0%, #FFFFFF 84.13%)",
      ...
      {
        imageSrc: "../images/Cards Images/Green Space.webp",
        title: "محیط زیست و فضای سبز",
        description:
          "طرح‌های توسعه فضای سبز شیراز در کنار باغ‌های تاریخی مثل ارم و عفیف‌آباد، هوای پاک و مناظری دلپذیر برای شهروندان فراهم کرده و دلیل لقب شهر باغ‌ها شده است.",
        likeCount: "۲۵",
        cardBackground:
          "radial-gradient(208.41% 100% at 100% 0%, #D5F5DA 0%, #FFFFFF 84.13%)",
    ...
    function generateCardHtml(cardData) {
      return `<div class="card-sm  col-md-4  mb-5"><div class="card w-100 h-100 shadow-sm border-0 " style="background: ${
        cardData.cardBackground
      };"><img src="${cardData.imageSrc}" class="card-img-top" alt="${
        cardData.imageAlt
      }"><div class="card-body d-flex flex-column"><h5 class="card-title text-center mt-3">${
        cardData.title
      }</h5><p class="card-text text-justify">${
        cardData.description
      }</p><div class="bottom-panel d-flex justify-content-around align-items-center"><div class="like"><i class="fa-solid fa-heart"></i><small class="text-muted">${
        cardData.likeCount
      }</small></div><div class="information d-flex justify-content-between align-items-center" style="background: ${
        cardData.panelColor
      };">${cardData.stats
        .map(
          (stat) =>
            `<div class="d-flex flex-column align-items-center"><small class="text-muted">${stat.value}</small><p class="mb-0 small">${stat.label}</p></div>`
        )
  ...
  if (mapContainer) {
    const districtData = {
      1: {
        name: "منطقه ۱",
        address: "شیراز، چهارراه خلدبرین، جنب پارک خلدبرین، شهرداری منطقه ۱",
        phone: "۰۷۱-۳۶۴۷۶۰۴۴",
      },
      2: {
        name: "منطقه ۲",
        address:
          "شیراز، بلوار دلاوران بسیج، ابتدای بلوار رازی، شهرداری منطقه ۲",
        phone: "۰۷۱-۳۷۲۵۹۸۰۸",
      },
      3: {
        name: "منطقه ۳",
        address:
          "شیراز، خیابان ساحلی شرقی، حد فاصل پل هجرت و پل علی ابن حمزه، شهرداری منطقه ۳",
        phone: "۰۷۱-۳۲۲۸۸۹۸۱۱",
      },
      4: {
        name: "منطقه ۴",
        address:
          "شیراز،ابتدای بلوار امیرکبیر، پایانه امیرکبیر، شهرداری منطقه ۴",
        phone: "۰۷۱-۳۸۳۱۰۵۰۱",
      },
      5: {
        name: "منطقه ۵",
        address: "شیراز، بلوار رحمت، رو به رو بوستان سعدی، شهرداری منطقه ۵",
        phone: "۰۷۱-۳۷۳۹۷۱۷۰",
      },
      6: {
        name: "منطقه ۶",
        address: "شیراز، گلدشت معالی آباد، شهرداری منطقه ۶",
        phone: "۰۷۱-۳۶۳۵۱۴۵۰",
      },
      7: {
        name: "منطقه ۷",
        address:
          "شیراز، بلوار فرصت شیرازی، ابتدای خیابان ساحلی، ایستگاه شماره ۷ آتش نشانی، شهرداری منطقه ۷",
        phone: "۰۷۱-۳۷۲۲۰۰۷۷",
      },
      8: {
        name: "منطقه ۸",
        address: "شیراز، سه راه آستانه، شهرداری منطقه ۸",
        phone: "۰۷۱-۳۷۳۶۲۰۲۴",
      },
      9: {
        name: "منطقه ۹",
        address: "شیراز،انتهای بلوار فرزانگان، بلوار طلاییه، شهرداری منطقه ۹",
        phone: "۰۷۱-۳۸۴۱۰۲۰۰",
      },
      10: {
        name: "منطقه ۱۰",
        address: "شیراز،بلوار دکتر حسابی، خیابان هاتف، شهرداری منطقه ۱۰",
        phone: "۰۷۱-۳۶۵۰۱۷۱۷",
      },
      11: {
        name: "منطقه ۱۱",
        address:
          "شیراز،بلوار سرداران، نرسیده به ضلع غربی پل غدیر، شهرداری منطقه ۱۱",
        phone: "۰۷۱-۳۷۲۵۹۹۰۹",
      },
    ...
    function loadDistrictInfo() {
      ...
      districtInfoList.innerHTML = Object.keys(districtData)
        .map((id) => {
    ...
    function setHighlight(districtId, isHighlighting) {
      ...
      const districtInfo = document.getElementById(
        `info-district-${districtId}`
      );
