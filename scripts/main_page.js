document.addEventListener("DOMContentLoaded", function() {
    ...
    if (mapContainer) {
        const districtData = {
            "1": { name: "منطقه ۱", address: "شیراز، بلوار ارم، جنب پارک ارم، شهرداری منطقه ۱", phone: "۰۷۱-۳۲۲۸xxxx" },
            "2": { name: "منطقه ۲", address: "شیراز، خیابان زند، روبروی بیمارستان شهید فقیهی، شهرداری منطقه ۲", phone: "۰۷۱-۳۲۳۲xxxx" },
            "3": { name: "منطقه ۳", address: "شیراز، چهارراه حافظیه، بلوار گلستان، شهرداری منطقه ۳", phone: "۰۷۱-۳۷۳۶xxxx" },
            "4": { name: "منطقه ۴", address: "شیراز، بلوار مدرس، جنب پایانه شهید مطهری، شهرداری منطقه ۴", phone: "۰۷۱-۳۷۲۷xxxx" },
            "5": { name: "منطقه ۵", address: "شیراز، بلوار ارتش، میدان بسیج، شهرداری منطقه ۵", phone: "۰۷۱-۳۸۲۳xxxx" },
            "6": { name: "منطقه ۶", address: "شیراز، بلوار چمران، تقاطع نیایش، شهرداری منطقه ۶", phone: "۰۷۱-۳۶۲۸xxxx" },
            "7": { name: "منطقه ۷", address: "شیراز، بلوار امیرکبیر، روبروی شهرک صنعتی، شهرداری منطقه ۷", phone: "۰۷۱-۳۸۳۳xxxx" },
            "8": { name: "منطقه ۸", address: "شیراز، خیابان قصرالدشت، جنب پارک خلدبرین، شهرداری منطقه ۸", phone: "۰۷۱-۳۶۲۶xxxx" },
            "9": { name: "منطقه ۹", address: "شیراز، بلوار عدالت، جنب بیمارستان شوشتری، شهرداری منطقه ۹", phone: "۰۷۱-۳۸۳۰۰xxx" },
            "10": { name: "منطقه ۱۰", address: "شیراز، شهرک گلستان، بلوار غدیر، شهرداری منطقه ۱۰", phone: "۰۷۱-۳۶۲۳xxxx" },
            "11": { name: "منطقه ۱۱", address: "شیراز، بلوار محراب، جنب شهرک والفجر، شهرداری منطقه ۱۱", phone: "۰۷۱-۳۷۲۲xxxx" }
        };
