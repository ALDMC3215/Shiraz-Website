document.addEventListener("DOMContentLoaded", function() {
    ...
    if (mapContainer) {
        const districtData = {
            "1": { name: "منطقه ۱", address: "شیراز، چهارراه خلدبرین، جنب پار خلدبرین، شهرداری منطقه ۱", phone: "۰۷۱-۳۶۴۷۶۰۴۴" },
            "2": { name: "منطقه ۲", address: "۲ شیراز، بلوار دلاوران بسیج، ابتدای بلوار رازی، شهرداری منطقه ", phone: "۰۷۱-۳۷۲۵۹۸۰۸" },
