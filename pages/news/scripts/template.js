...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const newsData = [
    ...
    },
    {
      ...
      fullText:
        "نمایشگاه بین‌المللی گل و گیاه شیراز با حضور فعال تولیدکنندگان داخلی و بین‌المللی، متخصصان باغبانی و علاقه‌مندان به طبیعت، در محل دائمی نمایشگاه‌های بین‌المللی فارس برگزار شد. این نمایشگاه فرصتی بی‌نظیر برای تبادل دانش و تجربه در زمینه صنعت گل و گیاه بود.",
    },
    {
      id: "news4",
      ...
      fullText:
        "عملیات اجرایی خط 3 مترو شیراز که مناطق جنوبی شهر را به مناطق شمالی متصل خواهد کرد، رسماً آغاز شد. این خط جدید با هدف گسترش شبکه حمل‌ونقل ریلی و کاهش ترافیک در محورهای اصلی شهر طراحی شده است.",
    },
    {
      id: "news5",
      ...
      fullText:
        "عملیات اجرایی بزرگترین مرکز درمانی تخصصی کودکان در جنوب کشور، با حضور مقامات کشوری و استانی، در شیراز آغاز شد. این بیمارستان مجهز به آخرین فناوری‌های پزشکی و بخش‌های فوق تخصصی برای درمان بیماری‌های کودکان خواهد بود.",
    },
    {
      id: "news6",
      title: "تقاطع غیرهمسطح شهیدان آماده بهره‌برداری",
      date: "۳ مرداد ۱۴۰۲",
      image: "./images/shahidan.webp",
      fullText:
        "شهردار شیراز گفت: تقاطع غیرهمسطح تقاطع شهیدان جعفر و حسن سرانجام (قائم-رحمت-احمدی جنوبی) در بلوار رحمت، به عنوان یکی از محورهای اصلی و شریانی این کلان‌شهر، احداث و آماده بهره‌برداری است.",
    },
  ];
